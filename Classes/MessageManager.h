...
public:
    ...
    void sendPrepareForWar(int petId,int targetId);
    void receiveTPrepareForWar(CCObject *obj);
    void sendReleaseRoleMessage(int petId);
    void receiveReleaseRole(CCObject *obj);
