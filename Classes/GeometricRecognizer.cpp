...
namespace DollarRecognizer
{
	...
	void GeometricRecognizer::loadTemplates()
	{
		...
		addTemplate("Circle", samples.getGestureDelete());//Delete
		addTemplate("Circle", samples.getGestureDiamond());//Diamond
		...
		addTemplate("Line", samples.getGestureLeftToRightLine());//LeftToRightLine
		addTemplate("Line", samples.getGestureLineDownDiagonal());
        //LineDownDiagonal
		addTemplate("Pigtail", samples.getGesturePigtail());
		addTemplate("Circle", samples.getGestureQuestionMark());//QuestionMark
		addTemplate("Circle", samples.getGestureRectangle());//Rectangle
		...
		addTemplate("Line", samples.getGestureRightToLeftLine());//RightToLeftLine
		addTemplate("Line", samples.getGestureRightToLeftLine2());//RightToLeftLine2
		addTemplate("Line", samples.getGestureRightToLeftSlashDown());//RightToLeftSlashDown
		...
		addTemplate("Circle", samples.getGestureX());//X
	}
